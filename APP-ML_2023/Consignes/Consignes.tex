...
\chead{\footnotesize }
\rhead{\footnotesize Version 3.1 -- 6 novembre 2022}
...
\begin {bclogo}[noborder=true, couleurBarre=Chocolate, logo=\bcinfo]{}
 ...
 \item[Dossier \file{Drilling-Problem}] : contient les fichiers pour traiter lea partie "problème" de l'APP.
...
Le travail se fait avec le notebook \file{ML-drilling.ipynb} du dossier \file{Drilling-Problem}. Le plan de trvail poposé est :
\begin{enumerate}
...
\item Rechercher parmi les données d'entraînement celles qui sont le plus pertinentes en considérant plus critères de pertinence.
\end{enumerate}
