...
\title[\hspace*{.8\linewidth}\insertframenumber/\inserttotalframenumber]
      ...
      \author[{\tiny avril 2023 -- V3.0}\hspace*{.8\linewidth}]{{\fontsize{8}{8}\selectfont{Jean-Luc.Charles\,@\,ENSAM.EU}}\\[5mm]
        \includegraphics[height=1.4cm]{images/logo-am-couleur-72dpi.jpg}}
\institute{}
\date{{\tiny septembre 2023}}
...
\begin{frame}{Machine Learning et IA}
  ...
  Plusieurs approches permettent de concevoir des algorithmes de {\em Machine Learning} :
    ...
    \bigskip
    \visible La suite traite uniquement des \bfdarkchoco{Réseau de neurones artificiels}.
\end{frame}
%===============================================================================
...
\end{tikzpicture}
  ...
  Un \bfdarkchoco{neurone artificiel}:
    \begin{itemize}
...
\begin{frame}{Réseaux de neurones étudiés}
  ...
  \bigskip
    La suite traite uniquement des \bfdarkchoco{réseaux de neurones denses}.
