...
%\subtitle{novembre 2021}
      \author[{\tiny avril 2022 -- V2.1}\hspace*{.8\linewidth}]{{\fontsize{8}{8}\selectfont{Jean-Luc.Charles\,@\,ENSAM.EU}}\\[5mm]
...
\begin{frame}{Mise en oeuvre dans l'APP}
  ...
  \begin{tcolorbox}[title=1 -- Auto-formation/ Réseau dense]
    \begin{itemize}
    \item Les trois {\em notebooks} \DarkBlue{\texttt{ML1\_MNIST.ipynb}},
      \DarkBlue{\texttt{ML2\_DNN.ipynb}} et \DarkBlue{\texttt{ML3\_DNN\_suite.ipynb}} visent les savoir-faire :
      \begin{itemize}
...
\begin{frame}{Mise en oeuvre dans l'APP}
  ...
  \begin{tcolorbox}[title=2 -- Auto-formation / Réseau convolutif]
    \begin{itemize}
    \item Le {\em notebook} \DarkBlue{\texttt{ML4\_CNN.ipynb}} vise les savoir-faire :
      \begin{itemize}
