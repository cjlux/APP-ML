...
\chead{\footnotesize }
\rhead{\footnotesize Version 3.0 -- 10 octobre 2022}
...
\begin {bclogo}[noborder=true, couleur=green!10, couleurBarre=DarkGreen, logo=\large\ding{220}]{}
  ...
  \setlength{\parsep}{-0.2mm}\setlength{\itemsep}{-0.4mm}    
    ...
    \item Créer l'EVP \DarkRed{\boldtt{minfo\_ml}} puis installer les modules Python nécessaires au {\em Machine Learning} ({\em cf} détails page suivante).
  \end{itemize} 
\end{bclogo}  
%
\vspace*{-3mm}
...
\begin {bclogo}[noborder=true, couleurBarre=Chocolate, logo=\large\ding{220}]{}
  ...
  \begin{itemize}
    \item Première heure et demie $\leadsto$ Préparation du rendu ;
    \item Dernière heure et demie $\leadsto$ Évaluation : présentation à l'enseignant du rendu du projet.
  \end{itemize}
\end{bclogo}  
...
\vspace*{-1mm}Télécharge depuis SAVOIR l'archive \file{APP-ML$\cdots$.zip} et \Chocolate{\textbf{extrais}} le dossier \file{APP-ML} sur ton ordinateur portable.
...
\begin {bclogo}[noborder=true, couleurBarre=Chocolate, logo=\bcinfo]{}
 ...
 \item[Fichier \file{requirements.txt}] : liste lds modules Python nécessaires au travail de l'APP.
\end{description}
\end{bclogo}  
%
\vspace*{-8mm}
